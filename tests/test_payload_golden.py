...
class PayloadGoldenTests(unittest.TestCase):
    ...
    def test_build_prompt_payload_hand_detailer_uses_lllite_mask(self) -> None:
        ...
        self.assertEqual(mask_node["inputs"]["segs"], [request["hand_detailer"]["lllite"]["runaway_guard_node_id"], 0])
        self.assertEqual(segs_node["inputs"]["labels"], "hand")
        self.assertEqual(hand_nodes[0]["class_type"], "DetailerForEach")
        self.assertEqual(hand_nodes[0]["inputs"]["segs"], [request["hand_detailer"]["runaway_guard_node_id"], 0])
        self.assertEqual(workflow[request["hand_detailer"]["max_filter_node_id"]]["inputs"]["take_count"], 12)
    ...
    def test_build_hand_detailer_postprocess_payload(self) -> None:
        ...
        self.assertEqual(nodes["SegsToCombinedMask"]["inputs"]["segs"], [request["hand_detailer"]["lllite"]["runaway_guard_node_id"], 0])
