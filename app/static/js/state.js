...
export function createInitialState() {
  return {
    ...
    contactLoadedWindowLimit: 0,
    contactRevision: "",
    contactRevisionLimit: 0,
    contactRevisionOffset: 0,
    contactListContextSeq: 0,
    contactLoadMoreInFlight: false,
    contactRefreshInFlight: false,
    contactPollingInFlight: false,
    contactLastRequest: {},
    contactLastResponse: {},
    contactLastApplied: {},
    contactLastIgnored: {},
