...
LUNA_COMFY_RESTART_ENABLED = os.environ.get("LUNA_COMFY_RESTART_ENABLED", "0")
COMFYUI_RESTART_COMMAND = os.environ.get("COMFYUI_RESTART_COMMAND", "")
COMFYUI_RESTART_TIMEOUT_SECONDS = os.environ.get("COMFYUI_RESTART_TIMEOUT_SECONDS", "180")
COMFYUI_RESTART_POLL_INTERVAL_SECONDS = os.environ.get("COMFYUI_RESTART_POLL_INTERVAL_SECONDS", "3")
COMFYUI_RESTART_CWD = os.environ.get("COMFYUI_RESTART_CWD", "")
COMFYUI_RESTART_SHELL = os.environ.get("COMFYUI_RESTART_SHELL", "0")
