...
const actionContracts = [
  ...
  "assist-restore",
  "comfy-restart",
  "comfy-restart-status",
  "signature-image-clear",
...
const apiPathContracts = [
  ...
  ["app/static/js/settings.js", "/api/system/comfyui/restart-capability"],
  ["app/static/js/settings.js", "/api/system/comfyui/restart"],
  ["app/static/js/settings.js", "/api/system/comfyui/restart-status"],
  ["app/static/js/settings.js", "/api/signatures/upload"],
  ["app/static/js/history.js", "/public-save/status"],
...
const domIds = [
  ...
  "#loraSlotSummary",
  "#quickControlsSummary",
  "#tuningQuickStatus",
  "#resetComfyCache",
  "#comfyCacheResetStatus",
  "#advancedAssistSummary",
  "#comfyRestartBadge",
  "#comfyRestartStatus",
  "#comfyRestartButton",
  "#publicSaveFinishEnabled",
  "#publicSaveFinishPreset",
  "#publicSaveFinishStatus",
  "#watermarkMode",
